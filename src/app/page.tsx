...
export default function Home() {
  useEffect(() => {
    // Initialize scrollcraft engine
    const w = window as unknown as { ScrollCraft?: { mount: (el: Element) => void } };
    if (w.ScrollCraft) {
      w.ScrollCraft.mount(document.body);
    }
  }, []);
  ...
  return (
    <main>
      {/* Progress bar */}
      <div data-sc-progress className="sc-progress" />
      ...
      <section className="pre-hero">
        <div className="pre-hero__inner">
          ...
          <h1 className="pre-hero__h" data-sc-kinetic="lines">Your new workspace<br />between coffee &amp; craft beer.</h1>
      ...
      <div data-sc-mode="worldflight" data-sc-seam="0.12">
        ...
        <div data-sc-world-copy>
          ...
          {/* Leg 1 copy — Hero */}
          <div data-sc-copy data-sc-window="hero" data-sc-cue="0 0.8" className="sc-copy--center">
          ...
          {/* Leg 2 copy — Problem */}
          <div data-sc-copy data-sc-window="0.20 0.38" data-sc-cue="0.20 0.38" className="sc-copy--lead">
          ...
          {/* Leg 3 copy — Solution */}
          <div data-sc-copy data-sc-window="0.40 0.58" data-sc-cue="0.40 0.58" className="sc-copy--trail">
          ...
          {/* Leg 4 copy — Features */}
          <div data-sc-copy data-sc-window="0.60 0.78" data-sc-cue="0.60 0.78" className="sc-copy--lead">
          ...
          {/* Leg 5 copy — CTA */}
          <div data-sc-copy data-sc-window="finale" data-sc-cue="0.80 1.0" data-sc-spotlight className="sc-copy--center">
